...
\todo[inline]{This paragraph can provide an example of a
functional program. In particular reference the performance
of the Haskell book: "Central to functional programming is the
idea of a function, which computes a result that depends
on the value of its inputs}

\input{figures/02_background/imperative_example.tex}

\input{figures/02_background/functional_example.tex}
